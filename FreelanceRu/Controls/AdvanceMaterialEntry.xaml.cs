...
public partial class AdvanceMaterialEntry : Grid
{
    ...
    public static readonly BindableProperty HasErrorProperty = BindableProperty.Create(
        ...
        (bindable, oldValue, newValue) =>
        {
            ...
            view.placeholderText.TextColor = view.errorText.IsVisible ? Color.FromArgb("#ff0000") : Color.FromArgb("#ffffff");
    ...
    private async Task ControlUnfocused()
    {
        ...
        this.placeholderText.TextColor = this.HasError ? Color.FromArgb("#ff0000") : Color.FromArgb("#ffffff");
